...
## Code embeddings
Finally, we give the code embeddings generated according to the above method to obtain performance values based on these code embeddings. Due to anonymity requirements and storage limitations, we only upload a subset of the data under folder embeddings.       
